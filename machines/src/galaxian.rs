...
/// over the *bus view* rather than the board, because the games on this board
/// hand the CPU different register sets.
struct Drive<'a, B: GalaxianBus> {
    cpu: &'a mut Z80,
    bus: &'a mut B,
}

impl<B: GalaxianBus> ScanlineDriven for Drive<'_, B> {
