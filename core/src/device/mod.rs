...
pub use discrete::{
    ...
    DiscreteCircuitBuilder, ExternalSourceId, FilterMode, InverterOsc, LfsrOutput, LfsrShift,
...
pub use starwars_math::StarWarsMath;
